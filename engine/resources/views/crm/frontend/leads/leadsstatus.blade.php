                ...
                <main>
                    ...
                    <div class="container-xl px-4 mt-4">
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        <form>
                                            <div class="row gx-3 mb-3">
                                                <div class="col-md-6">
                                                    <label class="small mb-1" for="inputstatusname">Status Name</label>
                                                    <input class="form-control" id="inputstatusname" type="text" value="" />
                                                </div>
                                            </div>
                                            <div class="row gx-3 mb-3">
                                                <div class="col-md-6">
                            ...
                            <div class="col-xl-8">
                                <div class="card">
                                    <div class="card-header">List Status</div>
                                        <div class="card-body">
